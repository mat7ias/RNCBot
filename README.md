...
note: The dApp is shown as live development progress. To send payments you will need to run a full Raiden node. You can start it on Goerli with "--eth-rpc-endpoint https://rpc.slock.it/goerli" to try it without syncing an Ethereum node (or use Infura).
