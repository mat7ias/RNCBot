...
To run a full Raiden node, follow the [workshop](https://github.com/raiden-network/workshop/tree/tu-berlin-blockchain-labs). If you happen to be on Windows, [this community video](https://youtu.be/RpaAS64dI6k) shows starting a node with WSL. You can skip signing up for Infura on Goerli by adding ""--eth-rpc-endpoint https://rpc.slock.it/goerli". So start command being (in replacement of [this](https://github.com/raiden-network/workshop/tree/tu-berlin-blockchain-labs#running-raiden)):
```
